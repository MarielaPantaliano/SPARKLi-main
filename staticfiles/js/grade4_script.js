document.addEventListener('DOMContentLoaded', function() {
  ...
  function displaySummaryAnswers() {
    ...
    if (storedAnswers && answersContainer1 && answersContainer2 && answersContainer3 && answersContainer4 && answersContainer5&& answersContainer6 && answersContainer7) {
      ...
      answersContainer6.innerHTML = answers.answ6;
      answersContainer7.innerHTML = answers.answ7;
    }
  }
...
function saveAnswersG4PreOral() {
  saveAnswers();
  window.location.href = 'g4_pretest_summary.html';
}
...
function analyzeAnswers() {
  ...
  // AJAX request to analyze answers
  $.ajax({
...
function displayResults(results) {
  var resultContainers = {
      ...
      "answ6": document.getElementById('result-ans6'),
      "answ7": document.getElementById('result-ans7')
  };
...
// Function to create result HTML for individual answers
...
function saveAndRedirect1() {
  window.location.href = 'g4_pretest_overall.html';
}

function saveAndRedirect2() {
  window.location.href = 'g4_posttest_overall.html';
}
