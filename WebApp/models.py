...
class Studentrecords(models.Model):
    ...
    gradesection = models.CharField(max_length=50, blank=True, null=True)
    ...
    total_miscues = models.IntegerField(blank=True, null=True, default=0)
    oral_reading_score = models.IntegerField(blank=True, null=True, default=0)
    reading_level = models.CharField(max_length=255, blank=True, null=True, default=0)
    post_total_miscues = models.IntegerField(blank=True, null=True, default=0)
    post_oral_reading_score = models.IntegerField(blank=True, null=True, default=0)
    post_reading_level = models.CharField(max_length=255, blank=True, null=True, default=0)

    # Pre-assessment fields
    pre_total_scores = models.CharField(max_length=25, blank=True, null=True, default=0)
    pre_literal_scores = models.CharField(max_length=25, blank=True, null=True, default=0)
    pre_inferential_scores = models.CharField(max_length=25, blank=True, null=True, default=0)
    pre_applied_scores = models.CharField(max_length=25, blank=True, null=True, default=0)
    pre_literal_fb = models.CharField(max_length=255, blank=True, null=True, default=0)
    pre_inferential_fb = models.CharField(max_length=255, blank=True, null=True, default=0)
    pre_applied_fb = models.CharField(max_length=255, blank=True, null=True, default=0)
    pre_level_fb = models.CharField(max_length=255, blank=True, null=True, default=0)

    # Post-assessment fields
    post_total_scores = models.CharField(max_length=25, blank=True, null=True, default=0)
    post_literal_scores = models.CharField(max_length=25, blank=True, null=True, default=0)
    post_inferential_scores = models.CharField(max_length=25, blank=True, null=True, default=0)
    post_applied_scores = models.CharField(max_length=25, blank=True, null=True, default=0)
    post_literal_fb = models.CharField(max_length=255, blank=True, null=True, default=0)
    post_inferential_fb = models.CharField(max_length=255, blank=True, null=True, default=0)
    post_applied_fb = models.CharField(max_length=255, blank=True, null=True, default=0)
    post_level_fb = models.CharField(max_length=255, blank=True, null=True, default=0)
...
class PreTestPassage(models.Model):
    ...
    def __str__(self):
        return f"Grade {self.pretest_grade_level} Pre-Test Passage {self.pretest_passage_title}"
