...
GRADE4_POST_ANSWERS = {
        ...
        "answ4": ["100 years", "one hundred years"],
        "answ5": [ "list"],
        "answ6": [  "Yes, because it is time to thank the Lord for the privilege of witnessing 100 years of existence.",
                  "Yes, because these celebrations happen only once in a lifetime.",
                  "No, I won't go for a big one but one that is meaningful."],
         "answ7": [  "Games",
                  "Thanksgiving rites",
                  "Sports",
                  "Party",
